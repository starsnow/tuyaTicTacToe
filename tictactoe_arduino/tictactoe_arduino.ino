...
//    initCube2812();
    ...
    game.registerCallbackWhenGameOver(cbWhenGameOver);
...
void refreshUI()
{
    ...
    my_device.mcu_dp_update(DPID_WIN_LINE, game.getWinLine(), 4);
}
